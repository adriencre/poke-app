...
import com.example.pokedex.di.DatabaseModule_ProvideDatabaseFactory;
import com.example.pokedex.di.DatabaseModule_ProvideFavoritePokemonDaoFactory;
import com.example.pokedex.di.NetworkModule_ProvideLoggingInterceptorFactory;
import com.example.pokedex.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.pokedex.di.NetworkModule_ProvidePokeApiServiceFactory;
import com.example.pokedex.di.NetworkModule_ProvideRetrofitFactory;
...
import com.example.pokedex.presentation.detail.PokemonDetailViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.pokedex.presentation.detail.PokemonDetailViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.example.pokedex.presentation.favorites.FavoritesViewModel;
import com.example.pokedex.presentation.favorites.FavoritesViewModel_HiltModules;
import com.example.pokedex.presentation.favorites.FavoritesViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.pokedex.presentation.favorites.FavoritesViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.example.pokedex.presentation.list.PokemonListViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.pokedex.presentation.list.PokemonListViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerPokedexApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends PokedexApp_HiltComponents.ActivityC {
    ...
    Map keySetMapOfClassOfAndBooleanBuilder() {
      ...
      mapBuilder.put(PokemonDetailViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, PokemonDetailViewModel_HiltModules.KeyModule.provide());
      mapBuilder.put(PokemonListViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, PokemonListViewModel_HiltModules.KeyModule.provide());
  ...
  private static final class ViewModelCImpl extends PokedexApp_HiltComponents.ViewModelC {
    ...
    Provider<PokemonDetailViewModel> pokemonDetailViewModelProvider;

    Provider<PokemonListViewModel> pokemonListViewModelProvider;
    ...
    Map hiltViewModelMapMapOfClassOfAndProviderOfViewModelBuilder() {
      ...
      mapBuilder.put(PokemonDetailViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (pokemonDetailViewModelProvider)));
      mapBuilder.put(PokemonListViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (pokemonListViewModelProvider)));
      return mapBuilder.build();
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.pokemonDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.pokemonListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.pokedex.presentation.favorites.FavoritesViewModel
          return (T) new FavoritesViewModel(singletonCImpl.favoriteRepositoryImplProvider.get());

          case 1: // com.example.pokedex.presentation.detail.PokemonDetailViewModel
          return (T) new PokemonDetailViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.pokemonRepositoryImplProvider.get(), singletonCImpl.favoriteRepositoryImplProvider.get());

          case 2: // com.example.pokedex.presentation.list.PokemonListViewModel
          return (T) new PokemonListViewModel(singletonCImpl.pokemonRepositoryImplProvider.get());
  ...
  private static final class SingletonCImpl extends PokedexApp_HiltComponents.SingletonC {
    ...
    Provider<PokedexDatabase> provideDatabaseProvider;
    ...
    Provider<PokeApiService> providePokeApiServiceProvider;

    Provider<PokemonRepositoryImpl> pokemonRepositoryImplProvider;
    ...
    FavoritePokemonDao favoritePokemonDao() {
      return DatabaseModule_ProvideFavoritePokemonDaoFactory.provideFavoritePokemonDao(provideDatabaseProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<PokedexDatabase>(singletonCImpl, 1));
      this.favoriteRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<FavoriteRepositoryImpl>(singletonCImpl, 0));
      ...
      this.providePokeApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<PokeApiService>(singletonCImpl, 3));
      this.pokemonRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<PokemonRepositoryImpl>(singletonCImpl, 2));
    }

    @Override
    public void injectPokedexApp(PokedexApp pokedexApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.pokedex.data.repository.FavoriteRepositoryImpl
          return (T) new FavoriteRepositoryImpl(singletonCImpl.favoritePokemonDao());

          case 1: // com.example.pokedex.data.local.PokedexDatabase
          return (T) DatabaseModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 2: // com.example.pokedex.data.repository.PokemonRepositoryImpl
          return (T) new PokemonRepositoryImpl(singletonCImpl.providePokeApiServiceProvider.get());

          case 3: // com.example.pokedex.data.remote.PokeApiService
